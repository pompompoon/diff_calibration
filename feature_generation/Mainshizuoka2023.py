...
def analyze_shizuoka_2023_data(base_dir, output_dir, metadata_path, sensitivity_threshold=1, velocity_threshold=30, exclude_initial_seconds=0):
    """
    ...
    if all_results:
        ...
        output_file = os.path.join(output_dir, f'shizuoka2023_EyeCenterAngle_saccade_analysis_sens{sensitivity_threshold}_vel{velocity_threshold}_excl{exclude_initial_seconds}s.csv')
...
if __name__ == "__main__":
    ...
    metadata_path = r"G:\共有ドライブ\GAP_長寿研\user\iwamoto\視線の動きの俊敏さ\feature_generation\fdata\shizuoka2023_metadata.csv"
