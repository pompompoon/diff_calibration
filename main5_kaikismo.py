...
# SMOTE関連の段階的インポート
try:
    from models.regression_smotebackup import RegressionSMOTE, visualize_smote_effect
except ImportError:
    try:
        # フォルダ名が違う場合を考慮
...
def prepare_data_for_regression_with_smote(df, target_column='target', use_smote=False, 
                                           smote_method='density', **smote_kwargs):
    """
    データの前処理を行う関数（回帰用SMOTE付き）
